                ...
                try:
                    ...
                    if debug: #Just display
                        ...
                        rec = {
                            ...
                            'ext_low': data['extremes']['ext_low'],
                            'ext_high': data['extremes']['ext_high'],
                            'sin_print': data['extremes']['sin_print'],
                            'le_f': data['extremes'].get('le_f', None),
                            'he_f': data['extremes'].get('he_f', None),
                            'sp_f': data['extremes'].get('sp_f', None),
                            'h_a_l': data['h_a_l'],
                            'ht': data['ht'],
                            'lt': data['lt']
                        }
