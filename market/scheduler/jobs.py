...
def start():
    ...
    scheduler.add_job(td_download_option_data.run, 'cron', day_of_week='mon-fri', hour='7', minute='40')
    scheduler.add_job(td_download_spot_data.run, 'cron', day_of_week='mon-fri', hour='7', minute='20')
