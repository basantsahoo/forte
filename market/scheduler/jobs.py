...
def start():
    ...
    scheduler.add_job(td_download_spot_data.run, 'cron', day_of_week='mon-sun', hour='9', minute='03')
    scheduler.add_job(td_download_option_data.run2, 'cron', day_of_week='mon-sun', hour='13', minute='10')
