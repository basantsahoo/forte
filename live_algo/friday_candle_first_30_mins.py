...
class FridayCandleFirst30Sell(CandlePatternStrategy):
    def __init__(self, insight_book,  id=None, pattern='CDLHIKKAKE', order_type="SELL", exit_time=10, period=5, trend=None, min_tpo=1, max_tpo=1, record_metric=True, triggers_per_signal=1, target_pct=[0.003,0.003, 0.004, 0.005], stop_loss_pct=[0.0015,0.002, 0.002,0.002]):
        CandlePatternStrategy.__init__(self, insight_book, id, pattern, order_type, exit_time, period, trend, min_tpo, max_tpo, record_metric, triggers_per_signal=triggers_per_signal, target_pct=target_pct, stop_loss_pct=stop_loss_pct)
        self.weekdays_allowed = ['Friday']
