...
class CandlePatternStrategy(BaseStrategy):
    ...
    def suitable_market_condition(self,matched_pattern):
        return len(self.insight_book.market_data.items()) < 375-self.exit_time
    ...
    def initiate_signal_trades(self, sig_key):
        ...
        triggers = [self.get_trades(curr_signal['pattern']['candle'], trd_idx) for trd_idx in range(next_trigger, next_trigger+1+1)]
