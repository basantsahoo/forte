...
from profile.utils import get_next_highest_index
...
class StateCapStrategy(BaseStrategy):
    ...
    def initiate_signal_trades(self, sig_key):
        ...
        triggers = [self.get_trades(curr_signal['pattern']['params']['probs'], trd_idx) for trd_idx in range(next_trigger, next_trigger+1+20)]
